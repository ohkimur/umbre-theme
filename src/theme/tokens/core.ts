...
export const coreTokenColors = ({ surfaces, syntax }: ThemeModel): TokenColor[] => [
  ...
  tokenRule("Number", ["constant.numeric"], syntax.number),
  tokenRule("Built-in Constants", ["constant.language", "support.constant"], syntax.constant),
  tokenRule("Variable", ["variable", "variable.parameter.function-call"], syntax.foreground),
  tokenRule("Member Variable", ["variable.member", "variable.other.property"], syntax.property),
